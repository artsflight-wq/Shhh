    ...
    <footer className="py-8 border-t border-white/5 bg-black/20">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-4">
          <h2 className="text-6xl md:text-7xl font-heading font-bold tracking-tighter select-none drop-shadow-[0_0_20px_rgba(59,130,246,0.4)]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-t border-white/5 pt-4">
