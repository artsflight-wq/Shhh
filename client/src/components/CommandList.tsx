      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {isLoading ? (
          ...
          <>
            ...
            {/* Pagination Controls */}
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 sm:gap-3 mt-12 mb-8">
                <button
                  onClick={() => setCurrentPage((prev) => Math.max(0, prev - 1))}
                  disabled={currentPage === 0}
                  className="group flex items-center gap-1 sm:gap-2 px-2 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-xl border border-white/10 rounded-xl transition-all duration-300 hover:from-white/20 hover:via-white/10 hover:to-white/5 hover:border-white/20 hover:scale-105 hover:shadow-[0_8px_24px_-8px_rgba(0,0,0,0.4)] disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:from-white/10 disabled:hover:via-white/5"
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 px-2.5 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-br from-primary/20 via-primary/10 to-transparent backdrop-blur-xl border border-primary/20 rounded-xl shadow-[inset_0_1px_0_0_rgba(88,101,242,0.2)]">
